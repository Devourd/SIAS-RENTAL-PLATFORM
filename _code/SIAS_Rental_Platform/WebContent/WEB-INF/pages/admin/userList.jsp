...
<html>
<head>
	<title>SquirrelBackstagemanagement system</title>
			...
			<nav class="navbar navbar-inverse">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#">SquirrelBackstagemanagement system</a>
					</div>
		...
		<div class="col-md-12">
			...
			<div class="btn-group">
				<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					Detail接口数据 <span class="caret"></span>
				</button>
			...
			<table id="grid-data" class="table table-condensed table-hover table-striped">
				...
				<tr>
					...
					<th data-column-id="phone">Phone Number号</th>
	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">信息Operation</h4>
			</div>
