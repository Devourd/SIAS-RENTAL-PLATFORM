...
<body>
	<div id="loginbox">
	<h1 style="text-align:center;">SiasRental Platformmanagement system</h1>
				...
				<div class="controls">
					<div class="main_input_box">
						<span class="add-on bg_lg"><i class="icon-user"></i> </span> <input
							...
							class="required" value="" placeholder="Account number" />
					</div>
				</div>
			</div>
			<div class="control-group">
    ...
    $("#loginform").validate({
        ...
        messages: {
        	phone:  "Please input用户名",
            password: {
                required: "Please inputPassword",
                minlength: jQuery.format("Password不能小于{0}个字符")
            }
        }
    });
