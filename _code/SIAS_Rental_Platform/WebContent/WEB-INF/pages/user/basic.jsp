        ...
        <div id="user_content">
            <div class="basic">
                <form:form action="../user/updateInfo" method="post" commandName="user" role="form">
                    <h1>Perfecting and Modifying Personal Information</h1><hr />
                    <div class="changeinfo">
                        <span>Nickname：</span>
                        <input class="in_info" type="text" name="username" placeholder="Please inputNickname" value="${cur_user.username}"/>
                    </div><hr />
                    <div class="changeinfo">
                    ...
                    <div class="changeinfo">
                        <span>QQ：</span>
                        <input class="in_info" type="text" name="qq" placeholder="Please inputQQ" value="${cur_user.qq}"/>
                    </div>
                    <input type="submit" class="setting-save" value="Preservation" />
                </form:form>
            </div>
            <!--
