...
<title>List of commodities</title>
	<!-- 分页 -->
		...
		<div id="content-header">
			<div id="breadcrumb">
				<a href="<%=basePath%>admin/indexs" title="Home page"
					class="tip-bottom"><i class="icon-home"></i>Home page</a> <a title="List of commodities"
					class="tip-bottom">List of commodities</a>
			</div>
		</div>
		<!--End-breadcrumbs-->
			...
			<!--Search栏-->
			 <form class="form-horizontal" id="myserchform" name="myform" action="<%=basePath%>admin/searchGoods" method="post">
				...
				<div  class="col-sm-8" style="text-align:center;">
					<span >商品ID：</span>
					<input type="number" placeholder="Please input number~" name="id" value="${searchgoods.id}"/>
					<span >Name：</span>
					<input type="text"  name="name" value="${searchgoods.name}"/>
					<span >Status:</span>
					<select name="status" id="myselected" >
					<option value="" selected="selected">选择商品States</option>
					<option value="1">On sale</option>
					<option value="0">Lower shelf</option>
					</select>
				</div>
					<div class="col-sm-4">
				...
				<tbody>
					<c:forEach items="${goodsGrid.rows}" var="item">
						<tr>
							...
							<span style="color:red">Lower shelf</span>
							</c:if>
							</td>
							<td>
   ...
   <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel" >Operation商品信息</h4>
            </div>
             ...
             <input type="hidden" id="id" name="id" value=""/>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						...
						<option value="0" selected="selected">Lower shelf</option>
...
<div class="modal fade" id="viewModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel" >Detail商品信息</h4>
            </div>
            <div class="modal-body" style="height:0 auto; ">
				...
				success:function(json){
					if(json){
						...
						if(json.status==1){
							...
							$('#myviewform').find("input[name='status']").val('Lower shelf');
						}
