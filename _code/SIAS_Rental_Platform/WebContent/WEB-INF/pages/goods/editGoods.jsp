            ...
            <div class="user_info">
              ...
              <!--   <span class="school">莆田学院</span> -->
                ...
                <span class="btn" data-toggle="modal" data-target="#myModal" style="width: 98%;background-color: rgb(79, 190, 246); color:rgba(255, 255, 255, 1);margin-top:0.5cm;">
                	My credit score：${cur_user.power}
                </span>
        ...
        <div id="user_content">
            <div class="basic">
                <form:form action="../../goods/editGoodsSubmit" method="post" role="form" enctype="multipart/form-data">
                    <h1 style="margin-left: 210px;">Operation物品信息</h1><hr />
                    <div class="changeinfo">
                        <span>Item name：</span>
                        <input class="in_info" type="text" name="name" placeholder="Please inputItem name" value="${goodsExtend.goods.name}"/>
                        <span>(*Must fill)</span>
                    </div>
                    <div class="changeinfo">
                        <span>Rental price：</span>
                        <input class="in_info" type="text" name="price" placeholder="Please inputRental price" value="${goodsExtend.goods.price}"/>
                       <span>(*Must fill)</span>
                   </div>
                   <div class="changeinfo">
                        <span>Original price：</span>
                        <input class="in_info" type="text" name="realPrice" placeholder="Please inputOriginal price" value="${goodsExtend.goods.realPrice}"/>
                    ...
                    <input type="submit" class="setting-save" value="提交Operation" style="margin-top: 20px;background-color: blue;"/>
                </form:form>
            </div>
            <!--
