...
public class OrdersController {
    ...
    public String addorders(HttpServletRequest request,Orders orders) {
    	Date d=new Date();//Get Time
    	SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");//Conversion format
        User cur_user = (User)request.getSession().getAttribute("cur_user");
        Integer user_id = cur_user.getId();
    ...
    /**
     * Delivery according to the order number
     */
    ...
    Integer orderNum=Integer.parseInt(request.getParameter("orderNum"));
    	...
    	/*After the buyer confirms the receipt, the seller’s wallet+*/
        return "redirect:/orders/myOrders";
    }
