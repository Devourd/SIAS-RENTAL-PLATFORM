...
<script type="text/javascript">
		...
		alert("发货成功，Please 送货给对方，并等待confirm收货~")
	}
        ...
        -->
			<div id="user_content">
				...
				<div class="share">
                    ...
                    描述： Order展示
                -->
					<h1 style="text-align: center">Order center</h1>
					<hr />
							...
							<div class="container">
								...
								<ul class="nav nav-tabs" role="tablist" style="width: 46%">
									<!-- <li class="nav-item"><a class="nav-link active"
										data-toggle="tab" href="#home">全部 Order</a></li> -->
									<li class="nav-item"><a class="nav-link active" data-toggle="tab"
										href="#orders_my" >I buy</a></li>
									<li class="nav-item" ><a class="nav-link" data-toggle="tab"
										href="#orders_other" >I sell</a></li>
								</ul>
										...
										<form class="form-horizontal" role="form">
											<div class="table-responsive">
                                            	...
                                            	<tr>
															...
															<td>
															<c:if test="${items.orderState==1}"><input type="button" value="Pending transactions" class="btn btn-info"/></c:if>
											...
											<div class="table-responsive">
												<table class="table">
                                            		...
                                            		<tr>
															...
															<c:if test="${items.orderState==2}"><input type="button" value="Goods to be received"  class="btn btn-info"/></c:if>
															<c:if test="${items.orderState==3}"><input type="button" value="Completed" class="btn btn-info"/></c:if>
