...
<head>
   ...
   $(function(){
       var options={
           ...
           currentPage:1,    //当前页数
           numberOfPages:5,    //最多showPage页
           totalPages:10,    //所有数据可以show的页数
          ...
          -->
                ...
                <div class="share_content">
                 <c:if test="${notice==null}">
                   ...
                   <c:if test="${notice!=null}">
                    <div class="yes_share">
                    <h1 style="text-align: center;">Purchase information</h1><hr>
                     ...
                     <p style="text-align:right;color:#4fbef6;">Releasetime：${item.createAt}</p>
                     <hr><br>
                     </c:forEach>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title middle" id="myModalLabel">Detail用户信息</h4>
            </div>
            <div class="modal-body" style="height: 220px;">
	         <form id="myviewform">
	          ...
	          <div class="form-group">
	            <label for="message-text" class="control-label col-sm-2">Phone Number号:</label>
	            <div class="col-sm-10">
	          ...
	          <div class="form-group">
	            <label for="message-text" class="control-label col-sm-2">开户time:</label>
	             <div class="col-sm-10">
