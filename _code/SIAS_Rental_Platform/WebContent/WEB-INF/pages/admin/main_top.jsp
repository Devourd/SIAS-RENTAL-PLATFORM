...
<body>
	...
	<div id="headers" >
	   	...
	   	<h1 style="text-align:center;margin-top: 10px;margin-bottom: 0px;">SiasRental Platformmanagement system</h1>
	   	</div>
		...
		<ul class="nav" style="height:50px;">
			<li class="dropdown" id="profile-messages"><a title="" href="#"
				...
				<ul class="dropdown-menu">
					...
					<li class="divider"></li>
					<li><a href="<%=basePath%>admin/modify"><i class="icon-check"></i>OperationPassword</a></li>
					<li class="divider"></li>
					<li><a href="<%=basePath%>admin"
						onclick="return confirm('confirmSign out吗？');"><i class="icon-key"></i>Sign out</a>
					</li>
				</ul>
			</li>
			<li class=""><a title="" href="<%=basePath%>admin"
				onclick="return confirm('confirmSign out吗？');"><i
					class="icon icon-share-alt"></i> <span class="text">Sign out</span> </a></li>
		</ul>
	</div>
	<!-- 实现左边动画 -->
