...
<head>
    <meta charset="UTF-8">
    <title>Release commodities</title>
        ...
        <div id="user_content">
            <div class="basic">
                <form:form action="../goods/publishGoodsSubmit" method="post" role="form" enctype="multipart/form-data">
                    <h1 style="margin-left: 210px;">Released</h1><hr />
                    <div class="changeinfo">
                        <span>Item name：</span>
                        <input class="in_info" type="text" name="name" placeholder="Please inputItem name"/>
                        <span>(*Must fill)</span>
                    </div>
                    <div class="changeinfo">
                        <span>Rental price：</span>
                        <input class="in_info" type="text" name="price" placeholder="Please inputRental price"/>
                        <span>(*Must fill)</span>
                    </div>
                    <div class="changeinfo">
                        <span>Original price：</span>
                        <input class="in_info" type="text" name="realPrice" placeholder="Please inputOriginal price"/>
                        <span id="checkphone">(*Please fill in the form truthfully.)</span>
                    </div>
                    <div class="changeinfo">
                        ...
                        <select class="in_info" name="catelogId">
                            ...
                            <option value="3">Life Electric</option>
                    ...
                    <input type="submit" class="setting-save" value="Released" style="margin-top: 20px;background-color: blue;"/>
                </form:form>
            </div>
            <!--
...
<script>
    $(".myfile").fileinput({
        ...
        showUpload: false, //是否show上传按钮,跟随文本框的那个
        showRemove : false, //show移除按钮,跟随文本框的那个
        showCaption: true,//是否show标题,就是那个文本框
        showPreview : true, //是否show预览,不写默认为true
        dropZoneEnabled: true,//是否show拖拽区域，默认不写为true，但是会占用很大区域
        //minImageWidth: 50, //Product的最小宽度
        //minImageHeight: 50,//Product的最小高度
        //maxImageWidth: 1000,//Product的最大宽度
        //maxImageHeight: 1000,//Product的最大高度
